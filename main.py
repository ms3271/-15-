...
# 기능 1: 안전한 비밀번호 생성기
# ==========================================
# 예외 처리: 사용자가 숫자가 아닌 문자나 너무 짧은 길이를 입력했을 때를 대비
...
def currency_converter():
    ...
    try:
        ...
        print("숫자만 입력해 주세요.")
# 가독성 향상: 각 기능의 가독성을 높이기 위해 직관적인 함수명과 분리 구조 적용
...
# ==========================================
def main():
    while True: # 메인 루프: 사용자가 6번(종료)을 누르기 전까지 프로그램을 무한 반복 실행
        print("\n파이썬 미니 툴킷 프로젝트")
        ...
        # 사용자 입력: 메뉴 선택 시 공백이 입력되어도 오류가 나지 않도록 .strip() 처리
...
if __name__ == "__main__":
    main()
# 프로그램 종료: 사용자가 종료를 선택하면 안전하게 루프를 빠져나감
